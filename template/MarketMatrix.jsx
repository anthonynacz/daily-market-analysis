 ...
 * Window: last 3 days (Jun 2) → coming 2 weeks (Jun 19).
 *
...
// 18-day axis: Jun 2 .. Jun 19 (last 3 days → coming 2 weeks). Today = index 3 (Jun 5).
const DAYS = [
  ...
  { idx: 9, date: "Jun 11", dow: "Thu" },
  { idx: 10, date: "Jun 12", dow: "Fri" },
  { idx: 11, date: "Jun 13", dow: "Sat" },
  { idx: 12, date: "Jun 14", dow: "Sun" },
  { idx: 13, date: "Jun 15", dow: "Mon" },
  { idx: 14, date: "Jun 16", dow: "Tue" },
  { idx: 15, date: "Jun 17", dow: "Wed" },
  { idx: 16, date: "Jun 18", dow: "Thu" },
  { idx: 17, date: "Jun 19", dow: "Fri" },
];
const TODAY_IDX = 3;
...
const EVENTS = [
  ...
  // ---- FORWARD CATALYSTS (week 2: Jun 11–19) ------------------------------
  { id: "x1", ind: "tech", dayIdx: 11, future: true, impact: 2, dir: "MIXED",
    headline: "AI-capex read-through continues post ORCL/Broadcom prints", tickers: "NVDA · AVGO · ORCL",
  ...
  { id: "x2", ind: "health", dayIdx: 13, future: true, impact: 2, dir: "MIXED",
    ...
    rec: "Volatility persists; favor LLY on a clean reta profile, fade knee-jerk NVO moves." },
  { id: "x3", ind: "finance", dayIdx: 15, future: true, impact: 3, dir: "MIXED",
    headline: "FOMC decision — Jun 17 (Warsh's first meeting as Chair)", tickers: "JPM · BAC · SPY · TLT",
    rec: "Biggest macro swing in the window; keep dry powder into the dots & presser." },
  { id: "x4", ind: "energy", dayIdx: 16, future: true, impact: 2, dir: "MIXED",
    headline: "EIA inventories + OPEC+ follow-through", tickers: "XOM · CVX · USO",
    rec: "Trade the Hormuz risk premium with trailing stops; a de-escalation unwinds it fast." },
  { id: "x5", ind: "finance", dayIdx: 17, future: true, impact: 2, dir: "MIXED",
    ...
    <div style={S.root}>
      <div style={S.header}>
        <div>
          ...
          <div style={S.sub}>
            Snapshot <b style={{ color: "#e2e8f0" }}>Friday, Jun 5 2026</b> · window: last 3 days → next 2 weeks ·
