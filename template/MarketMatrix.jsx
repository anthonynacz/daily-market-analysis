 ...
 *
 * Snapshot date: Friday, June 5, 2026 (live-researched).
 * Window: last 3 days (Jun 2) → coming 5 days (Jun 10).
 *
...
// 9-day axis: Jun 2 .. Jun 10. Today = index 3 (Jun 5).
const DAYS = [
  { idx: 0, date: "Jun 2", dow: "Tue" },
  { idx: 1, date: "Jun 3", dow: "Wed" },
  { idx: 2, date: "Jun 4", dow: "Thu" },
  { idx: 3, date: "Jun 5", dow: "Fri" }, // TODAY
  { idx: 4, date: "Jun 6", dow: "Sat" },
  { idx: 5, date: "Jun 7", dow: "Sun" },
  { idx: 6, date: "Jun 8", dow: "Mon" },
  { idx: 7, date: "Jun 9", dow: "Tue" },
  { idx: 8, date: "Jun 10", dow: "Wed" },
];
const TODAY_IDX = 3;
...
const EVENTS = [
  ...
  { id: "t1", ind: "tech", dayIdx: 2, future: false, impact: 3, dir: "BEARISH",
    headline: "Broadcom Q2: AI guide light; AVGO −12–15%", tickers: "AVGO",
    rec: "Wait for stabilization; only nibble below ~$400 — guidance, not results, was the miss." },
  { id: "t2", ind: "tech", dayIdx: 3, future: false, impact: 3, dir: "BEARISH",
    headline: "Chip stocks fall a 2nd day on AVGO read-through (NVDA −1.4%, AMD −2.8%)", tickers: "NVDA · AMD · MU",
  ...
  { id: "t3", ind: "tech", dayIdx: 0, future: false, impact: 3, dir: "BULLISH",
    headline: "Huang calls Marvell 'next trillion-$ company'; MRVL +32%", tickers: "MRVL",
    rec: "Trim into a 30%+ pop; wait for a pullback to add." },
  { id: "t4", ind: "tech", dayIdx: 8, future: true, impact: 3, dir: "MIXED",
    headline: "May CPI print (8:30 ET) — hot risk for high-multiple tech", tickers: "NVDA · MSFT · GOOGL",
    rec: "De-risk slightly pre-print; a cool number is the bull catalyst, a hot one hits megacap multiples." },
  { id: "t5", ind: "tech", dayIdx: 8, future: true, impact: 3, dir: "MIXED",
    headline: "Oracle FQ4 earnings — AI-capex tell after the AVGO scare", tickers: "ORCL",
    rec: "Wait for earnings; strong OCI bookings re-rate the AI-infra trade, a weak guide deepens the selloff." },

  // ---- ENERGY -------------------------------------------------------------
  { id: "e1", ind: "energy", dayIdx: 3, future: false, impact: 3, dir: "MIXED",
    headline: "Crude stays elevated (WTI ~$92–95) as Strait of Hormuz stays shut", tickers: "XOM · CVX · COP",
  ...
  { id: "e3", ind: "energy", dayIdx: 5, future: true, impact: 3, dir: "MIXED",
    headline: "OPEC+ 41st ministerial — quota / policy decision (Sun)", tickers: "XOM · CVX · OXY · USO",
    rec: "Cut new directional bets into Sunday; a surprise larger hike is bearish crude, a hold/cut is bullish." },
  { id: "e4", ind: "energy", dayIdx: 7, future: true, impact: 3, dir: "BULLISH",
    headline: "Hormuz / Bab-al-Mandeb escalation risk persists", tickers: "XOM · CVX · OXY",
  ...
  { id: "e6", ind: "energy", dayIdx: 8, future: true, impact: 2, dir: "MIXED",
    ...
    rec: "Watch the draw vs. consensus; a big draw amid the Hormuz closure reinforces the bull case." },

  // ---- HEALTHCARE / PHARMA ------------------------------------------------
  { id: "h1", ind: "health", dayIdx: 3, future: true, impact: 3, dir: "MIXED",
    headline: "ADA 2026 opens — Lilly retatrutide TRIUMPH-1 readout", tickers: "LLY · NVO · VKTX",
    rec: "Expect GLP-1 volatility; size before headlines, don't chase. A clean reta win = bullish LLY / bearish NVO." },
  { id: "h2", ind: "health", dayIdx: 0, future: false, impact: 3, dir: "BEARISH",
    headline: "Abivax UC win marred by malignancy signal; ABVX −40%", tickers: "ABVX",
    rec: "Avoid the falling knife until the malignancy / regulatory question is resolved." },
  { id: "h3", ind: "health", dayIdx: 2, future: false, impact: 2, dir: "BULLISH",
    headline: "Biotech M&A best year since 2019 ($106B YTD)", tickers: "PFE · MRK · ABBV · XBI",
    rec: "Tailwind for SMID-cap biotech (XBI); tilt to de-risked names that fit pharma's revenue gap." },
  { id: "h4", ind: "health", dayIdx: 3, future: false, impact: 2, dir: "BULLISH",
    headline: "Pfizer/Arvinas VEPPANU approved early — first-ever PROTAC degrader", tickers: "PFE · ARVN",
    rec: "Already priced in; hold ARVN for launch execution, not a date-driven pop." },
  { id: "h5", ind: "health", dayIdx: 3, future: true, impact: 2, dir: "BEARISH",
    headline: "CMS sets flat 2027 Medicare Advantage rate (vs ~5% for 2026)", tickers: "UNH · HUM · CVS",
    rec: "Margin headwind; stay cautious / underweight managed care until 2027-rate + DOJ clarity improve." },

  // ---- FINANCIALS ---------------------------------------------------------
  { id: "f1", ind: "finance", dayIdx: 3, future: false, impact: 3, dir: "MIXED",
    headline: "May jobs +172K blow past ~85K est.; 10Y yield jumps to ~4.54%", tickers: "JPM · BAC · WFC · GS",
    rec: "Favor NII-beneficiary banks (JPM/BAC); trim long-duration / asset-manager exposure." },
  { id: "f2", ind: "finance", dayIdx: 3, future: false, impact: 3, dir: "MIXED",
    headline: "2026 rate-HIKE odds jump to ~57% post-jobs", tickers: "JPM · BAC · V · MA",
    rec: "Position higher-for-longer: asset-sensitive banks win; avoid adding rate-duration before 6/17 FOMC." },
  { id: "f3", ind: "finance", dayIdx: 2, future: false, impact: 2, dir: "BULLISH",
    headline: "Financials rally — KBW Bank Index +3.6% (GS, BX, ARES lead)", tickers: "GS · BX · ARES · MS",
    rec: "Take partial profits into strength rather than chase a 3.6% one-day index move." },
  { id: "f4", ind: "finance", dayIdx: 1, future: false, impact: 2, dir: "MIXED",
    headline: "Visa/Mastercard $200B swipe-fee settlement still contested", tickers: "V · MA",
    rec: "Hold V/MA as quality compounders; expect ruling volatility, don't trade the noise." },
  { id: "f5", ind: "finance", dayIdx: 8, future: true, impact: 3, dir: "MIXED",
    headline: "May CPI (8:30 ET) — first big print before Warsh's FOMC", tickers: "JPM · BAC · V · MA",
  ...
  { id: "c1", ind: "consumer", dayIdx: 1, future: false, impact: 3, dir: "MIXED",
    headline: "May auto sales: Ford −14% as affordability bites; hybrids surge", tickers: "F · GM · TM",
    rec: "Trim/avoid Ford on volume erosion; lean to hybrid-strong names; hold TSLA pending June deliveries." },
  { id: "c2", ind: "consumer", dayIdx: 0, future: false, impact: 2, dir: "BULLISH",
    headline: "GameStop Q1 record net income $390M; +12% after hours", tickers: "GME",
    rec: "Meme-risk name — don't chase the pop; take partial profits if held, size small." },
  { id: "c3", ind: "consumer", dayIdx: 1, future: false, impact: 2, dir: "BULLISH",
    headline: "Walmart pulls forward 'Walmart Deals' (Jun 22–28) to body-check Amazon", tickers: "WMT · AMZN · TGT",
    rec: "Constructive for WMT traffic / share gains; hold or add into the promo calendar." },
  { id: "c4", ind: "consumer", dayIdx: 7, future: true, impact: 1, dir: "MIXED",
    headline: "GameStop Q1 formal earnings call (results pre-released)", tickers: "GME",
    rec: "No new fundamentals expected — don't add into a known event." },
  { id: "c5", ind: "consumer", dayIdx: 8, future: true, impact: 2, dir: "MIXED",
    headline: "Target annual shareholders meeting — turnaround / guidance watch", tickers: "TGT",
    rec: "Wait-and-see; use any traffic / tariff tone shift to decide whether to fade or buy weakness." },
];

// ------------------------------------------------------------------ options
const OPTION_PLAYS = [
  { ticker: "AAPL", name: "Apple", rank: 1, spot: "~$310",
    catalyst: "WWDC 2026 keynote — Mon Jun 8 (Siri / AI re-rating)",
    iv: "~25% — cheap/moderate", liq: "Deepest equity chain in the market; penny-wide spreads, huge OI",
    thesis: "Rare combo of a hard 3-day catalyst + cheap IV = asymmetric upside if the AI story lands, with limited IV-crush risk.",
    ideas: [
      { profile: "Conservative", text: "$300 call · Jul 17 '26 · ~$14.50 (ITM, Δ≈0.65)" },
      { profile: "Moderate",     text: "$310 call · Jun 19 '26 · ~$6.50 (ATM)" },
      { profile: "Aggressive",   text: "$325 call · Jun 12 '26 · ~$1.80 (OTM, pure WWDC pop)" },
    ] },
  { ticker: "ORCL", name: "Oracle", rank: 2, spot: "~$236",
    catalyst: "FQ4 FY26 earnings — Wed Jun 10 (after close)",
    iv: "~73% / IVR ~90 — very elevated (±~12% implied)", liq: "Deep, very active AI-infrastructure chain",
    thesis: "AI-infra bookings booming (OCI +243% YoY) into a high-conviction print. Rich IV → favor ITM to survive the crush.",
    ideas: [
      { profile: "Conservative", text: "$230 call · Jul 17 '26 · ~$14.50 (ITM, Δ≈0.6)" },
      { profile: "Moderate",     text: "$237.50 call · Jun 19 '26 · ~$11.50 (ATM)" },
      { profile: "Aggressive",   text: "$260 call · Jun 12 '26 · ~$3.50 (OTM; needs the implied move — max crush risk)" },
    ] },
  { ticker: "ADBE", name: "Adobe", rank: 3, spot: "~$258",
    ...
    thesis: "Down ~25% YTD and just rotating up with software; oversold, low expectations, $25B buyback support into the print.",
    ideas: [
      { profile: "Conservative", text: "$250 call · Jul 17 '26 · ~$14.00 (ITM, Δ≈0.6)" },
      { profile: "Moderate",     text: "$260 call · Jun 19 '26 · ~$8.00 (ATM)" },
      { profile: "Aggressive",   text: "$275 call · Jun 12 '26 · ~$2.50 (OTM)" },
    ] },
  { ticker: "FDX", name: "FedEx", rank: 4, spot: "~$331",
    catalyst: "Q4 FY26 earnings — ~Jun 18 (after close); post Freight spinoff",
    iv: "Elevated into earnings; unusual call activity flagged", liq: "Deep, liquid large-cap chain",
    thesis: "Two stacked catalysts — just-completed FedEx Freight spinoff re-rating + earnings — on a raised FY26 EPS guide.",
    ideas: [
      { profile: "Conservative", text: "$320 call · Jul 17 '26 · ~$14.00 (ITM, Δ≈0.6)" },
      { profile: "Moderate",     text: "$332.50 call · Jun 19 '26 · ~$9.00 (ATM)" },
      { profile: "Aggressive",   text: "$350 call · Jun 19 '26 · ~$3.00 (OTM breakout)" },
    ] },
  { ticker: "NKE", name: "Nike", rank: 5, spot: "~$44",
    catalyst: "Q4 FY26 earnings — ~Jun 30 (after close)",
    iv: "~54% (±~11% implied)", liq: "Deep mega-cap chain; low share price = cheap $ premiums",
    thesis: "Max-pessimism turnaround near 11-yr lows; any 'less-bad' Greater-China print re-rates off a deeply depressed base. Cheap asymmetric bet.",
    ideas: [
    ...
    <div style={S.root}>
      <div style={S.header}>
        <div>
          ...
          <div style={S.sub}>
            Snapshot <b style={{ color: "#e2e8f0" }}>Friday, Jun 5 2026</b> · window: last 3 days → next 5 days ·
      ...
      <div style={S.disclaimer}>
        ⚠ Educational analysis, <b>not financial advice</b>. Headlines/dates were live-researched on Jun 5 2026; option premiums are
