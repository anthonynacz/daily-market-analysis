 ...
 *
 * Snapshot date: Monday, June 8, 2026 (live-researched).
 * Window: last 3 days (Jun 5) → coming 2 weeks (Jun 22).
 *
...
// 18-day axis: Jun 5 .. Jun 22 (last 3 days → coming 2 weeks). Today = index 3 (Jun 8).
const DAYS = [
  { idx: 0, date: "Jun 5", dow: "Fri" },
  { idx: 1, date: "Jun 6", dow: "Sat" },
  { idx: 2, date: "Jun 7", dow: "Sun" },
  { idx: 3, date: "Jun 8", dow: "Mon" }, // TODAY
  { idx: 4, date: "Jun 9", dow: "Tue" },
  { idx: 5, date: "Jun 10", dow: "Wed" },
  { idx: 6, date: "Jun 11", dow: "Thu" },
  { idx: 7, date: "Jun 12", dow: "Fri" },
  { idx: 8, date: "Jun 13", dow: "Sat" },
  { idx: 9, date: "Jun 14", dow: "Sun" },
  { idx: 10, date: "Jun 15", dow: "Mon" },
  { idx: 11, date: "Jun 16", dow: "Tue" },
  { idx: 12, date: "Jun 17", dow: "Wed" },
  { idx: 13, date: "Jun 18", dow: "Thu" },
  { idx: 14, date: "Jun 19", dow: "Fri" },
  { idx: 15, date: "Jun 20", dow: "Sat" },
  { idx: 16, date: "Jun 21", dow: "Sun" },
  { idx: 17, date: "Jun 22", dow: "Mon" },
];
const TODAY_IDX = 3;
...
const EVENTS = [
  ...
  { id: "t1", ind: "tech", dayIdx: 0, future: false, impact: 3, dir: "BEARISH",
    headline: "Chips/tech sell off hard — NVDA −6%, worst chip day in months on Fed-hike fears", tickers: "NVDA · AVGO · AMD",
    rec: "Don't catch the knife day one; let the AI-trade sentiment reset, scale into quality (NVDA) on stabilization." },
  { id: "t2", ind: "tech", dayIdx: 3, future: false, impact: 3, dir: "BULLISH",
    headline: "Nvidia unveils LG / SK Hynix / SK Telecom AI partnerships + new 'super chip'; Huang reaffirms AI outlook", tickers: "NVDA",
    rec: "Constructive re-rating catalyst; add on confirmation, but mind the Fed-driven multiple risk into CPI." },
  { id: "t3", ind: "tech", dayIdx: 2, future: false, impact: 2, dir: "MIXED",
    headline: "AI-capex jitters linger after Broadcom guide; software/semis choppy into ORCL print", tickers: "AVGO · ORCL · NVDA",
    rec: "Trim high-beta into the print; reassess after Oracle's OCI / RPO bookings." },
  { id: "t4", ind: "tech", dayIdx: 5, future: true, impact: 3, dir: "MIXED",
    headline: "Oracle FQ4 earnings (after close) — AI-infra capex tell; Street ~$1.96 EPS / $19.1B rev · BINARY", tickers: "ORCL",
    rec: "Defined-risk only into the binary; strong OCI / RPO bookings re-rate AI-infra, a soft guide deepens the selloff." },
  { id: "t5", ind: "tech", dayIdx: 6, future: true, impact: 3, dir: "MIXED",
    headline: "Adobe FQ2 earnings (after close) — AI-on-core worry vs. $25B buyback · BINARY", tickers: "ADBE",
    rec: "Oversold with a low bar; sell elevated premium below support rather than chase — IV crush is the post-print risk." },
  { id: "x1", ind: "tech", dayIdx: 11, future: true, impact: 2, dir: "MIXED",
    headline: "Megacap-tech multiples in focus into FOMC; high-multiple names most rate-sensitive", tickers: "NVDA · MSFT · GOOGL",
    rec: "Keep dry powder into the decision; a hawkish hold pressures long-duration tech." },
  { id: "x2", ind: "tech", dayIdx: 4, future: true, impact: 2, dir: "MIXED",
    headline: "Pre-CPI positioning — high-multiple tech de-risks into Wednesday's print", tickers: "NVDA · MSFT",
    rec: "De-risk slightly pre-print; a cool CPI is the bull catalyst, a hot one hits megacap multiples." },

  // ---- ENERGY -------------------------------------------------------------
  { id: "e1", ind: "energy", dayIdx: 0, future: false, impact: 3, dir: "MIXED",
    headline: "WTI slides ~3% to ~$90 on weaker demand + stalled US-Iran talks, even with Hormuz near-shut", tickers: "XOM · CVX · COP",
    rec: "Keep core E&P as supply-shock insurance; use the dip to add, trailing stops on ceasefire risk." },
  { id: "e2", ind: "energy", dayIdx: 3, future: false, impact: 2, dir: "BULLISH",
    headline: "Strait of Hormuz stays ~95% shut; OPEC+ adds only +188k bpd for July — supply stays tight", tickers: "XOM · CVX · OXY · USO",
    rec: "Tactical energy overweight as a geopolitical hedge; favor integrated majors (XOM/CVX)." },
  { id: "e3", ind: "energy", dayIdx: 5, future: true, impact: 2, dir: "MIXED",
    ...
    rec: "A big draw amid the Hormuz closure reinforces the bull case; trade inventories tactically." },
  { id: "e4", ind: "energy", dayIdx: 12, future: true, impact: 2, dir: "MIXED",
    headline: "EIA petroleum report (week 2) — crude inventories", tickers: "XOM · CVX · USO",
    rec: "Watch the draw vs. consensus; geopolitics still dominates fundamentals right now." },
  { id: "e5", ind: "energy", dayIdx: 10, future: true, impact: 1, dir: "MIXED",
    headline: "OPEC monthly oil market report — 2026 demand-growth revisions", tickers: "XOM · CVX · OXY",
    rec: "Watch demand revisions; a cut to 2026 demand caps the geopolitical risk premium." },
  { id: "x3", ind: "energy", dayIdx: 16, future: true, impact: 1, dir: "MIXED",
    headline: "Hormuz / OPEC+ headline risk into late June — ceasefire vs. escalation binary", tickers: "XOM · CVX · USO",
    rec: "Trade the risk premium with trailing stops; a de-escalation unwinds it fast." },

  // ---- HEALTHCARE / PHARMA ------------------------------------------------
  { id: "h1", ind: "health", dayIdx: 3, future: false, impact: 3, dir: "BULLISH",
    headline: "Lilly files orforglipron (oral GLP-1) for obesity; pipeline lead widens vs. Novo", tickers: "LLY · NVO",
    rec: "Constructive for LLY; the oral-GLP-1 filing de-risks the next launch — add on weakness, not strength." },
  { id: "h2", ind: "health", dayIdx: 1, future: false, impact: 2, dir: "MIXED",
    headline: "Novo's oral Wegovy tops forecasts (~2M Q1 scripts) but 2026 earnings guide stays soft", tickers: "NVO · LLY",
    rec: "NVO is a value/turnaround debate; favor LLY for growth, size NVO small on the discount." },
  { id: "h3", ind: "health", dayIdx: 7, future: true, impact: 2, dir: "MIXED",
    headline: "GLP-1 / obesity data flow continues; pricing & access headlines", tickers: "LLY · NVO · VKTX",
    rec: "Expect GLP-1 volatility; favor LLY on pipeline breadth, fade knee-jerk NVO moves." },
  { id: "h4", ind: "health", dayIdx: 13, future: true, impact: 1, dir: "MIXED",
    headline: "Managed-care / CMS policy overhang persists into the 2027 rate debate", tickers: "UNH · HUM · CVS",
    rec: "Stay cautious / underweight managed care until 2027-rate clarity improves." },

  // ---- FINANCIALS ---------------------------------------------------------
  { id: "f1", ind: "finance", dayIdx: 0, future: false, impact: 3, dir: "MIXED",
    headline: "2026 rate-HIKE bets jump after hot data; 10Y yields grind higher, banks whipsaw", tickers: "JPM · BAC · WFC · GS",
    rec: "Favor asset-sensitive / NII banks (JPM/BAC); avoid adding rate-duration into the 6/17 FOMC." },
  { id: "f2", ind: "finance", dayIdx: 5, future: true, impact: 3, dir: "MIXED",
    headline: "May CPI (8:30 ET) — first big inflation print before FOMC; April ran 3.8% YoY", tickers: "SPY · JPM · TLT",
    rec: "Biggest swing risk of the week; keep dry powder — a hot print revives hike fears." },
  { id: "f3", ind: "finance", dayIdx: 11, future: true, impact: 3, dir: "MIXED",
    headline: "FOMC begins (Jun 16–17) — Warsh-led Fed; funds at 3.50–3.75%, hold widely expected", tickers: "JPM · BAC · SPY · TLT",
    rec: "Position higher-for-longer; the dots & presser are the real catalyst, not the hold itself." },
  { id: "f4", ind: "finance", dayIdx: 12, future: true, impact: 3, dir: "MIXED",
    headline: "FOMC decision + SEP / dot plot + presser (2:00 / 2:30 ET)", tickers: "SPY · QQQ · TLT · JPM",
    rec: "Biggest macro swing in the window; let the dots set the tone before re-risking." },
  { id: "f5", ind: "finance", dayIdx: 12, future: true, impact: 2, dir: "MIXED",
    headline: "May retail sales (8:30 ET) — consumer-resilience check", tickers: "XRT · WMT · AMZN",
    rec: "A soft print revives slowdown worries; a firm one supports higher-for-longer." },

  // ---- CONSUMER / RETAIL --------------------------------------------------
  { id: "c1", ind: "consumer", dayIdx: 2, future: false, impact: 2, dir: "MIXED",
    headline: "Consumer sentiment soft as energy-driven inflation bites; discretionary lags staples", tickers: "XLY · XLP · WMT",
    rec: "Tilt to staples / value (WMT) over discretionary while energy inflation pressures wallets." },
  { id: "c2", ind: "consumer", dayIdx: 7, future: true, impact: 1, dir: "BULLISH",
    headline: "Summer promo calendar ramps; Walmart / Amazon deal events loom", tickers: "WMT · AMZN · TGT",
  ...
  { id: "c3", ind: "consumer", dayIdx: 13, future: true, impact: 2, dir: "MIXED",
    headline: "Quarterly triple witching — Jun 18 (Jun 19 is Juneteenth, market closed)", tickers: "SPY · QQQ · IWM",
    rec: "Expect elevated volume & pin risk; avoid initiating new size into the expiry." },
  { id: "c4", ind: "consumer", dayIdx: 17, future: true, impact: 1, dir: "MIXED",
    headline: "Late-June retail / freight earnings season kicks off (NKE, FDX on deck)", tickers: "NKE · FDX",
    rec: "Wait for prints; position defined-risk into late-June earnings rather than pre-positioning." },
];
...
const OPTION_PLAYS = [
  { ticker: "ORCL", name: "Oracle", rank: 1, spot: "~$210", sentiment: "Bullish",
    catalyst: "FQ4 earnings — Wed Jun 10 (after close) · BINARY",
    iv: "~70% / IVR ~90 — VERY RICH (±~11% implied)", liq: "Deep, very active AI-infrastructure chain; tight spreads",
    thesis: "Bullish into a binary with expensive IV → avoid naked long calls (max crush). Cut vega with a debit spread, or get paid via defined-risk short premium below support.",
    ideas: [
      { profile: "Conservative", strategy: "Bull Call Debit Spread", text: "Buy $205 / sell $225 · Jul 17 '26 · ~$9 net debit · max loss $9 · vega-reduced" },
      { profile: "Moderate",     strategy: "Cash-Secured Put", text: "Sell $195 put · Jun 18 '26 · ~$5.50 credit · net buy $189.50; collateral ~$19.5k" },
      { profile: "Aggressive",   strategy: "Put Credit Spread", text: "Sell $200 / buy $190 · Jun 18 '26 · ~$3 credit · max loss $7 · harvests IV crush" },
    ] },
  { ticker: "ADBE", name: "Adobe", rank: 2, spot: "~$385 (est.)", sentiment: "Neutral-to-Bullish",
    ...
    thesis: "Oversold, low expectations, $25B buyback — but a binary print → defined-risk, range-tolerant structures. Sell elevated premium below support; spread up for cheap upside.",
    ideas: [
      { profile: "Conservative", strategy: "Put Credit Spread", text: "Sell $370 / buy $360 · Jul 17 '26 · ~$3 credit · max loss $7 · bullish, range-tolerant" },
      { profile: "Moderate",     strategy: "Bull Call Debit Spread", text: "Buy $385 / sell $405 · Jun 18 '26 · ~$8 net debit · max loss $8" },
      { profile: "Aggressive",   strategy: "Long Call (OTM)", text: "$400 call · Jun 18 '26 · ~$3 debit · earnings pop" },
    ] },
  { ticker: "NVDA", name: "NVIDIA", rank: 3, spot: "~$205 (est.)", sentiment: "Bullish",
    catalyst: "LG / SK partnerships + new 'super chip'; no earnings until Aug 26",
    iv: "~45% — MODERATE post-selloff, no near binary → low crush risk", liq: "Deepest semi chain in the market; penny-wide spreads, huge OI",
    thesis: "Fresh bullish catalysts with no near-term earnings crush → long premium is fair, but the Fed-hike scare caps multiples. Define cost with a debit spread; keep single longs under $15.",
    ideas: [
      { profile: "Conservative", strategy: "Bull Call Debit Spread", text: "Buy $200 / sell $215 · Jul 17 '26 · ~$7 net debit · max loss $7 · vega-light" },
      { profile: "Moderate",     strategy: "Long Call (ATM)", text: "$205 call · Jul 17 '26 · ~$11 debit · Δ≈0.55" },
      { profile: "Aggressive",   strategy: "Long Call (OTM)", text: "$220 call · Jun 18 '26 · ~$3 debit · pure momentum" },
    ] },
  { ticker: "XOM", name: "ExxonMobil", rank: 4, spot: "~$118 (est.)", sentiment: "Bullish",
    catalyst: "Hormuz supply-shock premium; OPEC+ keeps July add small (+188k bpd)",
    iv: "Elevated on the geopolitical premium (~30%)", liq: "Deep, liquid mega-cap energy chain",
    thesis: "Tight supply + Hormuz risk premium favor integrated majors, but a ceasefire reverses it fast → defined-risk and get paid to wait via a cash-secured put; trailing stops on directional bets.",
    ideas: [
      { profile: "Conservative", strategy: "Cash-Secured Put", text: "Sell $112 put · Jul 17 '26 · ~$3 credit · net buy $109; collateral ~$11.2k" },
      { profile: "Moderate",     strategy: "Bull Call Debit Spread", text: "Buy $118 / sell $128 · Jul 17 '26 · ~$4 net debit · max loss $4" },
      { profile: "Aggressive",   strategy: "Long Call (OTM)", text: "$125 call · Jun 18 '26 · ~$1.20 debit · geopolitical spike" },
    ] },
  { ticker: "LLY", name: "Eli Lilly", rank: 5, spot: "~$1,131", sentiment: "Bullish",
    catalyst: "Orforglipron obesity filing; GLP-1 pipeline lead widens vs. Novo",
    iv: "~38% — moderate; no near binary, GLP-1 headline-driven", liq: "Deep large-cap chain; wide strikes, high $ premiums",
    thesis: "Pipeline lead + oral-GLP-1 filing de-risk the growth story; rich stock so size in $-terms. Keep per-contract debit under $15 with tight spreads; sell range-tolerant premium below support.",
    ideas: [
      { profile: "Conservative", strategy: "Put Credit Spread", text: "Sell $1,100 / buy $1,080 · Jul 17 '26 · ~$7 credit · max loss $13 · bullish, range-tolerant" },
      { profile: "Moderate",     strategy: "Bull Call Debit Spread", text: "Buy $1,130 / sell $1,150 · Jun 18 '26 · ~$9 net debit · max loss $9" },
      { profile: "Aggressive",   strategy: "Long Call (OTM)", text: "$1,160 call · Jun 18 '26 · ~$6 debit · pipeline momentum" },
    ] },
];
...
// today line sits on the boundary between Jun 8 and Jun 9
    ...
    <div style={S.root}>
      <div style={S.header}>
        <div>
          ...
          <div style={S.sub}>
            Snapshot <b style={{ color: "#e2e8f0" }}>Monday, Jun 8 2026</b> · window: last 3 days → next 2 weeks ·
