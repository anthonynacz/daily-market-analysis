 ...
 *
 * Snapshot date: Wednesday, June 24, 2026 (live-researched).
 * Window: last 3 days (Jun 21) → coming 2 weeks (Jul 8).
 *
...
// 18-day axis: Jun 21 .. Jul 8 (last 3 days → coming 2 weeks). Today = index 3 (Jun 24).
const DAYS = [
  { idx: 0, date: "Jun 21", dow: "Sun" },
  { idx: 1, date: "Jun 22", dow: "Mon" },
  { idx: 2, date: "Jun 23", dow: "Tue" },
  { idx: 3, date: "Jun 24", dow: "Wed" }, // TODAY
  { idx: 4, date: "Jun 25", dow: "Thu" },
  { idx: 5, date: "Jun 26", dow: "Fri" },
  { idx: 6, date: "Jun 27", dow: "Sat" },
  { idx: 7, date: "Jun 28", dow: "Sun" },
  { idx: 8, date: "Jun 29", dow: "Mon" },
  { idx: 9, date: "Jun 30", dow: "Tue" },
  { idx: 10, date: "Jul 1", dow: "Wed" },
  { idx: 11, date: "Jul 2", dow: "Thu" },
  { idx: 12, date: "Jul 3", dow: "Fri" },
  { idx: 13, date: "Jul 4", dow: "Sat" },
  { idx: 14, date: "Jul 5", dow: "Sun" },
  { idx: 15, date: "Jul 6", dow: "Mon" },
  { idx: 16, date: "Jul 7", dow: "Tue" },
  { idx: 17, date: "Jul 8", dow: "Wed" },
];
const TODAY_IDX = 3;
...
const EVENTS = [
  ...
  { id: "t1", ind: "tech", dayIdx: 2, future: false, impact: 3, dir: "BEARISH",
    headline: "Global tech rout: Nasdaq −2.2%, KOSPI −10% as overseas funds dump chips on AI-overvaluation fears", tickers: "NVDA · TSM · SOXX",
    rec: "Don't chase the dip on day one; let the AI-capex 'air pocket' wash out — buy quality (NVDA) only as it stabilizes." },
  { id: "t2", ind: "tech", dayIdx: 2, future: false, impact: 3, dir: "BEARISH",
    headline: "Micron −13% in the rout into earnings; NVDA −3.2% to ~$202, TSM −5%", tickers: "MU · NVDA · TSM",
    rec: "MU's $1T valuation magnifies the pre-print swing — wait for the Jun 24 numbers before adding memory exposure." },
  { id: "t3", ind: "tech", dayIdx: 3, future: true, impact: 3, dir: "MIXED",
    headline: "Micron FQ3 earnings (AMC) — HBM-supercycle test; options price a ±17% move", tickers: "MU · NVDA · WDC",
    rec: "Defined-risk only into a ±17% binary; a clean beat + 2027 HBM guide re-rates memory, a soft guide cracks the $1T narrative." },
  { id: "t4", ind: "tech", dayIdx: 3, future: true, impact: 1, dir: "MIXED",
    headline: "NVIDIA annual shareholder meeting — Blackwell / Vera-Rubin ramp watch", tickers: "NVDA",
    rec: "Soft catalyst; hold core NVDA and don't trade the meeting headlines." },
  { id: "t5", ind: "tech", dayIdx: 4, future: true, impact: 3, dir: "MIXED",
    ...
    rec: "De-risk slightly pre-print; a hot number feeds the higher-for-longer Fed and pressures richly-valued semis." },
  { id: "t6", ind: "tech", dayIdx: 11, future: true, impact: 2, dir: "BULLISH",
    headline: "TSMC June / Q2 monthly revenue — AI/HPC demand proxy (early July)", tickers: "TSM · NVDA · AVGO",
    rec: "Strong monthly sales confirm the AI-infra trade; use as a re-add signal, not a reason to chase." },

  // ---- ENERGY -------------------------------------------------------------
  { id: "e1", ind: "energy", dayIdx: 1, future: false, impact: 3, dir: "BEARISH",
    headline: "WTI sinks to ~$72–74 (3-mo low) as US 60-day Iran sanctions waiver reopens supply", tickers: "XOM · CVX · USO",
    rec: "Trim crude-levered E&P into the de-escalation; the war-risk premium is unwinding fast." },
  { id: "e2", ind: "energy", dayIdx: 2, future: false, impact: 2, dir: "BEARISH",
    headline: "Hormuz traffic normalizes; Gulf producers lift output as IEA flags 2027 oversupply", tickers: "XLE · OXY · COP",
    rec: "Underweight broad energy; returning Iranian barrels cap rallies — keep only a small hedge for a roadmap collapse." },
  { id: "e3", ind: "energy", dayIdx: 4, future: true, impact: 2, dir: "MIXED",
    headline: "EIA weekly petroleum status report (crude/gasoline inventories)", tickers: "USO · XOM · CVX",
    rec: "Trade inventory prints with tight stops; a big build accelerates the downside as supply ramps." },
  { id: "e4", ind: "energy", dayIdx: 10, future: true, impact: 2, dir: "MIXED",
    headline: "EIA weekly petroleum report (Jul 1) — inventories as Iranian supply returns", tickers: "USO · XLE",
    rec: "Watch builds vs. consensus; the demand-vs-supply tug-of-war sets the near-term floor." },
  ...
  // ---- HEALTHCARE / PHARMA ------------------------------------------------
  { id: "h1", ind: "health", dayIdx: 16, future: true, impact: 3, dir: "BULLISH",
    headline: "Vera atacicept IgA-nephropathy PDUFA (Jul 7) — headline biotech binary of the window", tickers: "VERA",
    rec: "Date-certain catalyst; defined-risk only — approval re-rates VERA, a CRL is a sharp drawdown." },
  { id: "h2", ind: "health", dayIdx: 9, future: true, impact: 3, dir: "BULLISH",
    headline: "Ionis olezarsen (TRYNGOLZA) sHTG PDUFA decision (~Jun 30)", tickers: "IONS",
    rec: "Label-expansion binary; size with defined risk — approval extends the franchise, a delay stings." },
  { id: "h3", ind: "health", dayIdx: 2, future: false, impact: 2, dir: "BEARISH",
    headline: "TrumpRx expansion (>800 drugs) keeps the pricing overhang on branded pharma", tickers: "PFE · LLY · NVO",
    rec: "Stay cautious on branded pharma; favor names with clean near-term catalysts over the index." },
  { id: "h4", ind: "health", dayIdx: 1, future: false, impact: 2, dir: "BULLISH",
    headline: "Oral GLP-1 momentum builds; Viking (VKTX) firms on pipeline optimism", tickers: "VKTX · XBI",
    rec: "High-beta obesity name — size small; let Phase 3 data, not headlines, drive the position." },
  { id: "h5", ind: "health", dayIdx: 2, future: false, impact: 1, dir: "MIXED",
    headline: "Medicare Advantage denial-rate scrutiny vs. the 2027 rate tailwind", tickers: "UNH · HUM · CVS",
    rec: "Balanced setup; the ~3% 2027 rate cushions margins but headline risk persists — hold, don't add aggressively." },

  // ---- FINANCIALS ---------------------------------------------------------
  { id: "f1", ind: "finance", dayIdx: 2, future: false, impact: 3, dir: "MIXED",
    headline: "BofA rate-hike note + hawkish repricing sinks high-multiple growth (Nasdaq −2.2%)", tickers: "JPM · BAC · QQQ",
    rec: "Favor asset-sensitive banks (JPM/BAC) for the NIM tailwind; avoid long-duration tech as yields hold up." },
  { id: "f2", ind: "finance", dayIdx: 2, future: false, impact: 2, dir: "BULLISH",
    headline: "Deregulation seen freeing ~$140B bank capital; XLF outperforms the tape", tickers: "XLF · JPM · GS · MS",
    rec: "Constructive for big banks; hold core financials into the stress-test capital-return updates." },
  { id: "f3", ind: "finance", dayIdx: 3, future: true, impact: 3, dir: "BULLISH",
    headline: "Fed 2026 bank stress-test results (4pm ET) — 32 banks; capital-return setups", tickers: "JPM · BAC · WFC · GS · MS",
    rec: "Expect passes; dividend/buyback updates follow within days — own quality banks into the announcements." },
  { id: "f4", ind: "finance", dayIdx: 4, future: true, impact: 3, dir: "MIXED",
    headline: "May core PCE + final Q1 GDP (8:30 ET) — first big inflation tell post-FOMC", tickers: "JPM · BAC · V · MA",
    rec: "Biggest macro swing of the week; a hot print cements the hike path — bullish bank NIM, bearish the broad tape." },
  { id: "f5", ind: "finance", dayIdx: 5, future: true, impact: 2, dir: "BULLISH",
    headline: "Bank capital-return updates begin (dividends/buybacks) post stress test", tickers: "JPM · GS · MS · WFC",
    rec: "Reward-the-shareholder catalysts; lean to banks with the most excess capital and buyback headroom." },
  { id: "f6", ind: "finance", dayIdx: 11, future: true, impact: 3, dir: "MIXED",
    headline: "June jobs report (pulled to Thu Jul 2 ahead of Jul 4)", tickers: "SPY · XLF · TLT",
    rec: "Keep dry powder; a strong number accelerates the hike path and steepens the rate-sensitive trades." },

  // ---- CONSUMER / RETAIL --------------------------------------------------
  { id: "c1", ind: "consumer", dayIdx: 2, future: false, impact: 2, dir: "BEARISH",
    headline: "FedEx FQ4 beats ($6.31 vs $5.92) but −6% AH on soft CY26 guide + Freight-spinoff stranded costs", tickers: "FDX",
    rec: "Beat-and-fade — don't buy the dip until the transition-year cost drag and guide reset are digested." },
  { id: "c2", ind: "consumer", dayIdx: 2, future: false, impact: 1, dir: "MIXED",
    headline: "Nike names David Denton CFO (eff. Aug 17) at an 11-year low into Jun 30 earnings", tickers: "NKE",
    rec: "New-CFO signal is constructive long-term, but don't catch the knife pre-print — let the FY27 guide set the bottom." },
  { id: "c3", ind: "consumer", dayIdx: 3, future: false, impact: 2, dir: "BULLISH",
    headline: "Amazon Prime Day runs Jun 23–26; WMT/TGT counter-sales into July 4", tickers: "AMZN · WMT · TGT",
    rec: "Constructive for AMZN/WMT traffic; hold and read the discretionary spend signal into the holiday week." },
  { id: "c4", ind: "consumer", dayIdx: 9, future: true, impact: 3, dir: "MIXED",
    headline: "Nike Q4 FY26 earnings (AMC) + Conference Board Consumer Confidence (10am)", tickers: "NKE · XLY",
    rec: "Binary with rich IV; defined-risk only — an oversold setup can pop on any FY27-guide stabilization." },
  { id: "c5", ind: "consumer", dayIdx: 11, future: true, impact: 2, dir: "MIXED",
    headline: "Tesla Q2 deliveries (~Jul 2; GS sees ~420K) — auto-demand read", tickers: "TSLA · F · GM",
    rec: "Trade the reaction, don't pre-position; a beat lifts autos while a miss revives the demand-doubt narrative." },
];
...
const OPTION_PLAYS = [
  { ticker: "JPM", name: "JPMorgan Chase", rank: 1, spot: "~$330", sentiment: "Bullish",
    catalyst: "Fed stress-test results Wed Jun 24 (4pm ET) → capital-return updates; Q2 earnings ~Jul 14",
    ...
    thesis: "Hawkish Warsh Fed = higher-for-longer rates → NIM tailwind for the most rate-sensitive money-center bank; deregulation frees ~$140B capital; XLF outperforming as Big Tech sells off. IV still cheap → spread up.",
    ideas: [
  ...
  { ticker: "NVDA", name: "NVIDIA", rank: 2, spot: "~$200", sentiment: "Bullish",
    catalyst: "AGM Jun 24 + Micron read-through; no own earnings until late Aug (no binary in window)",
    iv: "Moderate — elevated realized vol from the rout, but no earnings premium", liq: "Deepest options chain in the market; penny-wide spreads, massive OI",
    thesis: "Sold off in the global AI-overvaluation rout with no own binary in the window → buy the rebound without paying an earnings-IV premium. Spread up to cut cost; scale in given the macro/PCE crosswinds, don't chase.",
    ideas: [
      { profile: "Conservative", strategy: "Long Call (ITM)", text: "$190 call · Jul 17 '26 · ~$15 debit · cost ~$1,500 · Δ≈0.62" },
      { profile: "Moderate",     strategy: "Bull Call Debit Spread", text: "Buy $200 / sell $215 · Jul 17 '26 · ~$6 net debit · cost/max loss ~$600" },
      { profile: "Aggressive",   strategy: "Long Call (OTM)", text: "$210 call · Jul 2 '26 · ~$2.50 debit · cost ~$250 · rebound continuation" },
    ] },
  { ticker: "NKE", name: "Nike", rank: 3, spot: "~$43", sentiment: "Bullish (contrarian)",
    catalyst: "Q4 FY26 earnings — Tue Jun 30 (after close) · BINARY (new CFO named Jun 23)",
    iv: "~54% (rich, ±~9–11% implied) on a beaten-down stock", liq: "Deep mega-cap chain; low-dollar premiums, tight spreads",
    thesis: "Max-pessimism turnaround at an 11-yr low, −40% off the high, with rich IV into a binary. Bullish + high IV → get paid via a defined-risk put-credit spread; cut vega with a debit spread; cheap call for the asymmetric pop.",
    ideas: [
      ...
      { profile: "Aggressive",   strategy: "Long Call (OTM)", text: "$46 call · Jul 2 '26 · ~$1.10 debit · cost ~$110 · pure earnings pop" },
    ] },
  { ticker: "VERA", name: "Vera Therapeutics", rank: 4, spot: "~$35", sentiment: "Bullish (binary)",
    ...
    thesis: "Breakthrough-designated, ORIGIN Phase 3 hit its primary endpoint, launch infra built. A date-certain binary with rich IV → DEFINED-RISK ONLY; a CRL is a total-premium loss, so spreads cap the damage and harvest crush on approval.",
    ideas: [
  ...
  { ticker: "XOM", name: "ExxonMobil", rank: 5, spot: "~$140", sentiment: "Bearish-to-Neutral",
    catalyst: "EIA inventories (Jun 25, Jul 1) + early-July OPEC+ output decision",
    iv: "Elevated but falling as the war premium unwinds (post-event crush)", liq: "Deep, liquid mega-cap chain; tight spreads",
    thesis: "Iran de-escalation + 60-day sanctions waiver + Hormuz reopening + IEA 2027-oversupply warning cap energy; WTI at a 3-mo low and Iranian barrels ramp. Falling IV → defined-risk debit/credit spreads over naked premium; two-way risk if the roadmap collapses.",
    ideas: [
      { profile: "Conservative", strategy: "Bear Call Credit Spread", text: "Sell $148 / buy $153 · Jul 17 '26 · ~$1.50 credit · max loss/capital ~$350 · profits if XOM stays below $148" },
      { profile: "Moderate",     strategy: "Bear Put Debit Spread", text: "Buy $140 / sell $130 · Jul 17 '26 · ~$3.50 net debit · cost/max loss ~$350" },
      { profile: "Aggressive",   strategy: "Long Put (OTM)", text: "$132 put · Jul 2 '26 · ~$1.20 debit · cost ~$120 · plays an EIA/OPEC+ downside break" },
    ] },
];
...
// today line sits on the boundary between Jun 24 and Jun 25
    ...
    <div style={S.root}>
      <div style={S.header}>
        <div>
          ...
          <div style={S.sub}>
            Snapshot <b style={{ color: "#e2e8f0" }}>Wednesday, Jun 24 2026</b> · window: last 3 days → next 2 weeks ·
