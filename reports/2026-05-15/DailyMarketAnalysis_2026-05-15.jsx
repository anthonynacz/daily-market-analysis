...
const EVENTS = [
  { id: 1, ticker: 'CSCO', headline: 'Cisco Q3 Earnings Beat, Shares Surge 13%', industry: 'Tech', date: '2026-05-14', impact: 'High', recommendation: 'BUY', reason: 'AI networking demand and raised guidance drive breakout' },
  { id: 2, ticker: 'CBRS', headline: 'Cerebras AI Chipmaker IPO Debut', industry: 'Tech', date: '2026-05-14', impact: 'High', recommendation: 'WATCH', reason: 'Hot AI debut but unproven at scale with volatile early trading' },
  { id: 3, ticker: 'AAPL', headline: 'Tech Selloff as Trump-Xi Summit Disappoints', industry: 'Tech', date: '2026-05-15', impact: 'High', recommendation: 'HOLD', reason: 'Profit-taking after summit yields no major policy breakthroughs' },
  { id: 4, ticker: 'AMAT', headline: 'Applied Materials Q2 Earnings Results', industry: 'Tech', date: '2026-05-14', impact: 'High', recommendation: 'HOLD', reason: 'Solid chip equipment demand but cautious forward guidance' },
  { id: 5, ticker: 'NVDA', headline: 'Nvidia Q1 Earnings Due Next Week', industry: 'Tech', date: '2026-05-20', impact: 'High', recommendation: 'WATCH', reason: 'AI bellwether with massive expectations already priced in' },
  { id: 6, ticker: 'BIIB', headline: 'Biogen Alzheimer Drug Advances to Phase 3', industry: 'Healthcare', date: '2026-05-14', impact: 'High', recommendation: 'BUY', reason: 'Breakthrough therapy shows strong clinical potential' },
  { id: 7, ticker: 'UNH', headline: 'UnitedHealth Faces Rising Medical Cost Pressure', industry: 'Healthcare', date: '2026-05-15', impact: 'Medium', recommendation: 'HOLD', reason: 'Elevated medical costs offset by strong enrollment trends' },
  { id: 8, ticker: 'JNJ', headline: 'J&J Talc Settlement Hearing This Week', industry: 'Healthcare', date: '2026-05-16', impact: 'Medium', recommendation: 'HOLD', reason: 'Legal uncertainty persists but pharma pipeline remains solid' },
  { id: 9, ticker: 'XOM', headline: 'Oil Surges as China Agrees to Buy US Crude', industry: 'Energy', date: '2026-05-15', impact: 'High', recommendation: 'BUY', reason: 'New China demand channel supports higher crude prices' },
  { id: 10, ticker: 'CVX', headline: 'Brent Crude Tops $107 Per Barrel', industry: 'Energy', date: '2026-05-15', impact: 'High', recommendation: 'BUY', reason: 'Elevated oil prices boost major integrated energy producers' },
  { id: 11, ticker: 'CSIQ', headline: 'Canadian Solar Q1 Earnings Report', industry: 'Energy', date: '2026-05-14', impact: 'Medium', recommendation: 'HOLD', reason: 'Solar sector faces margin pressure from global oversupply' },
  { id: 12, ticker: 'DIA', headline: 'Dow Jones Retakes 50,000 Milestone', industry: 'Finance', date: '2026-05-14', impact: 'High', recommendation: 'HOLD', reason: 'Milestone reached but sustainability depends on earnings follow-through' },
  { id: 13, ticker: 'TLT', headline: 'Treasury Yields Jump to 2026 Highs', industry: 'Finance', date: '2026-05-15', impact: 'High', recommendation: 'SELL', reason: 'Rising yields pressure bond prices and rate-sensitive sectors' },
  { id: 14, ticker: 'XLI', headline: 'Industrial Production Data Release', industry: 'Finance', date: '2026-05-16', impact: 'Medium', recommendation: 'WATCH', reason: 'Manufacturing output data will signal economic momentum direction' },
];
  ...
  return (
    <div style={{ background: '#0b0f1a', minHeight: '100vh', color: '#e2e8f0', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif', padding: '32px 16px' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <p style={{ color: '#64748b', fontSize: 14, marginBottom: 24 }}>2026-05-15 &middot; 14 events across 4 industries</p>
